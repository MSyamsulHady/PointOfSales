                        ...
                        <div class="card-body px-5 py-5">
                            ...
                            <form action="{{ route('prosesRegister') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control p_input" name="telepon">
                                </div>
                                <div class="form-group">
                                    <label for="gender" class="text-default">Jenis Kelamin</label>
                                ...
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <input type="text" class="form-control p_input" name="alamat">
                                </div>
